...
Then consider these two subway maps. Subway map A was designed by [[https://en.wikipedia.org/wiki/Lella_Vignelli][Lella Vignelli]] and subway map B was designed by [[https://en.wikipedia.org/wiki/Michael_Hertz_Associates][Michael Hertz Associates]], both on commission for the New York subway system[fn:15]:
...
[fn:15] These thematic versions of the New York subway were no doubt inspired by [[https://en.wikipedia.org/wiki/Harry_Beck][Harry Beck]]’s map:
[[file:images/Tube-map-Beck.jpg]]

[fn:14]  We also have various words used in different contexts to express two-ness: twice, double, pair, duo, couple.

[fn:13] In such cases anthropologists might say the originators were not fully aware of numerical abstraction, i.e., the “two-ness” of both bah and dah, rather, thought only in terms of bah tigers being more “cat-ness” than dah leopards.
